...
- [1. 简介与动机](ch01-introduction-and-motivation.md)
- [2. 快速上手](ch02-getting-started.md)
    - [核心关键字参考 *(可选)*](ch02-1-essential-keywords-reference.md)
- [3. 内置类型与变量](ch03-built-in-types-and-variables.md)
    - [真正的不可变性 vs Records 幻想](ch03-1-true-immutability-vs-record-illusions.md)
...
- [6. 枚举与模式匹配](ch06-enums-and-pattern-matching.md)
    - [穷尽式匹配与空安全](ch06-1-exhaustive-matching-and-null-safety.md)
...
- [8. Crates 与模块](ch08-crates-and-modules.md)
...
- [10. 特性 (Traits) 与泛型](ch10-traits-and-generics.md)
    - [泛型约束](ch10-1-generic-constraints.md)
    - [继承 vs 组合](ch10-2-inheritance-vs-composition.md)
- [11. From 与 Into Traits](ch11-from-and-into-traits.md)
- [12. 闭包与迭代器](ch12-closures-and-iterators.md)
    - [宏 (Macros) 入门](ch12-1-macros-primer.md)

---

# 第二部分 — 并发与系统编程

- [13. 并发编程](ch13-concurrency.md)
    - [异步/等待 (Async/Await) 深度解析](ch13-1-asyncawait-deep-dive.md)
...
- [15. 迁移模式与案例研究](ch15-migration-patterns-and-case-studies.md)
    - [C# 开发者必备的 Rust Crate](ch15-1-essential-crates-for-c-developers.md)
    - [渐进式引入策略](ch15-2-incremental-adoption-strategy.md)
...
- [17. 终极项目：构建 CLI 天气工具](ch17-capstone-project.md)
