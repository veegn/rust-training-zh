...
1. **Small effort, high impact** — most of these tricks take only a few lines to implement.
2. **Eliminate specific bug classes** — from "forgot to check sentinel" to "used closed session."
3. **Incremental improvement** — apply these tricks to your existing codebase as you find them useful.
